...
export default function Clothing() {
  const clothingProducts = initialProducts.filter(product => 
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        {clothingProducts.length} produk fashion terbaru
      </Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>Belum ada produk pakaian</Text>
          </View>
        }
      />
    </View>
